 ...
 */
const WalletExpenseCategorySchema = new Schema(
  {
...
WalletExpenseCategorySchema.index({ key: 1 }, { unique: true });
WalletExpenseCategorySchema.index({ isActive: 1, sortOrder: 1 });

export default mongoose.models.WalletExpenseCategory ||
  mongoose.model("WalletExpenseCategory", WalletExpenseCategorySchema);
