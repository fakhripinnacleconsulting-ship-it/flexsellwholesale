      ...
      try {
        ...
        if (match) {
          ...
          const updatedFields = {
            ...
            packagingCharge: imported.packagingCharge !== undefined ? imported.packagingCharge : (match.packagingCharge || 0),
            packagingChargeType: imported.packagingChargeType || match.packagingChargeType || "per_unit",
          ...
          const newProductData = {
            ...
            gstRate,
            priceIncludesGst: imported.priceIncludesGst !== undefined ? imported.priceIncludesGst : true,
            packagingCharge: imported.packagingCharge !== undefined ? imported.packagingCharge : 0,
            packagingChargeType: imported.packagingChargeType || "per_unit",
            moq: imported.moq !== undefined ? imported.moq : 1,
            seoTitle,
            seoDescription,
            seoKeywords,
