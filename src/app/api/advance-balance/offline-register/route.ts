 ...
 *
 * Cash credits visible only inside individual customer advanceBalances will never be reviewed
 * together, and a pattern across customers is exactly what a single Advance Balance cannot show.
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("[advanceBalance] Offline register failed:", error);
