...
export default function OfflineRegisterPage() {
  ...
  const fetchData = async () => {
    ...
    setError("");
    try {
      const result = await apiClient.get<OfflineRegisterData>(`/advance-balance/offline-register?days=${days}`);
      setData(result);
    } catch (err: any) {
                    ...
                    data.entries.map((entry) => (
                      <TableRow key={entry._id}>
                        ...
                        <TableCell>
                          ...
                          <p className="text-xs text-muted-foreground capitalize">{entry.walletType} Advance Balance</p>
                        </TableCell>
                        <TableCell>
