...
export function TransferFundsDialog({ customerName, availableBalance, open, onClose, onConfirm }: TransferFundsDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={(val) => !val && onClose()}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Move funds to Business Wallet</DialogTitle>
          <DialogDescription>
            Moving funds for {customerName}. This cannot be reversed. Business Wallet balance can only be spent on services and can never move back to the Store Wallet or be withdrawn.
          </DialogDescription>
        </DialogHeader>
