  ...
  return (
    <div className="invoice-document bg-white text-gray-900 max-w-[794px] mx-auto print:w-full print:max-w-none print:m-0 print:p-0 print:overflow-visible print:bg-white">
      ...
      <div data-print-area="true" className="invoice-document print-container border border-gray-200 rounded-xl p-6 sm:p-8 print:border-none print:rounded-none print:p-0 print:shadow-none print:w-full print:max-w-none print:overflow-visible">
        ...
        {/* ─── WARNING MESSAGE ─── */}
        {isQuote && hasMoqWarning && (
          <div className="bg-red-50 border-l-4 border-red-500 p-4 my-4 mb-6">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-bold text-red-800">Minimum Order Quantity (MOQ) Not Met</h3>
                <div className="mt-1 text-xs text-red-700">
                  <p>Some lines are below their Minimum Order Quantity. The wholesale rates shown apply only once each line meets its MOQ — raise the quantities before placing the order.</p>
                </div>
              </div>
            </div>
          </div>
