    ...
    <div className="space-y-6 container mx-auto px-4 py-8 text-foreground max-w-5xl">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 print:hidden border-b pb-4">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          {order.status === "Confirmed" && (hasPermission("orders_b2b", "update") || hasPermission("orders_b2c", "update") || hasPermission("orders_dropship", "update")) && (
            <Button
          ...
          {order.status !== "Cancelled" && (
            <>
              {(hasPermission("orders_b2b", "update") || hasPermission("orders_b2c", "update") || hasPermission("orders_dropship", "update")) && (
