    ...
    <div className="space-y-6 text-foreground container mx-auto px-4 py-8 max-w-6xl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
          ...
          {(hasPermission("customers_b2b", "create") || hasPermission("customers_b2c", "create") || hasPermission("customers_dropship", "create")) && (
                    ...
                    <tr key={cust._id} className="hover:bg-secondary/15 transition-colors">
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          <Link href={`${basePath}/customers/${cust._id}`}>
                            <Button variant="outline" size="sm" className="font-semibold h-8 w-8 p-0" title="View Profile">
                              <Eye className="h-3.5 w-3.5" />
                            </Button>
                          </Link>
                          {(hasPermission("customers_b2b", "update") || hasPermission("customers_b2c", "update") || hasPermission("customers_dropship", "update")) && (
                          ...
                          {(hasPermission("customers_b2b", "delete") || hasPermission("customers_b2c", "delete") || hasPermission("customers_dropship", "delete")) && (
